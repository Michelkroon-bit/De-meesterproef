...
zinnen = ["WELKOM BIJ LINGOOOOOOOOOOOOOOOOOOO DE LEUKSTE SPELSHOW VAN DE BENELUX\n" , #0
		...
		"GEFELICITEERDDDD JE HEBT LINGO BEHAALD!!!",#14
		"Je hebt helaas 3 pogingen gehad om het woord te raden maar het is niet gelukt het andere team is aan de beurt ",#15
		"GEFELICITEERDDDD je heb 3 groene ballen gepakt je heb gewonnen!!!!",#16
  		"heeft 3 keer het woord achter elkaar fout geraden jullie hebben verloren"]#17
getrokken_ballen = []
incorrect_streak = 0
beurt_team = 1
teams = []
